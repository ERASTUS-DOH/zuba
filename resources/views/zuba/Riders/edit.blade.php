...
@section('content')
    <div class="content">
        <div class="container-fluid">
            ...
            <form action="{{ route('updateRider',[$rider->id]) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header card-header-myDef">
                                <p class="card-category">Profile details of the Rider. </p>
                            </div>
                            <div class="card-body">
                                <div class="row mb-4 pt-4">
                                    <div class="col-md-2">
                                        <div class="form-group bmd-form-group is-filled">
                                            ...
                                            <input type="text" name="title" id="title" class="form-control" value="{{ $rider->title }}" >
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <div class="col-md-4">
                                        <div class="form-group bmd-form-group is-filled">
                                            ...
                                            <input type="text" name="fname" id="fname" class="form-control" value="{{ $rider->fname }}" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group bmd-form-group is-filled">
                                            ...
                                            <input type="text" id="other_name" name="other_name" class="form-control" value="{{ $rider->other_name }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group bmd-form-group is-filled">
                                            ...
                                            <input type="text" name="lname" id="lname" class="form-control" value="{{ $rider->lname }}">
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        <div class="form-group bmd-form-group is-filled">
                                            ...
                                            <input type="tel" name="telephone" id="telephone"  class="form-control" value="{{ $rider->telephone }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group bmd-form-group is-filled">
                                            <label for="email" class="bmd-label-floating">Email</label>
                                            <input type="email" name="email" id="email" class="form-control" value="{{ $rider->email }}" >
                                        </div>
                                    </div>
                                </div>
                            </div>
